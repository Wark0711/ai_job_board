...
import { formatExperienceLevel, formatJobListingLocation, formatJobType, formatLocationRequirement, formatWage } from "@/features/jobLists/lib/formatters"
...
export default function DailyJobListingEmail({ jobListings, serverUrl, userName }: { userName: string, jobListings: JobListing[], serverUrl: string }) {
    return (
        <Tailwind config={tailwindConfig}>
            <Html>
                ...
                <Container className="font-sans">
                    ...
                    <Text>Hi {userName}. Here are all the new job listings that meet your criteria.</Text>
                    <Section>
                        {
...
function getBadges(jobListing: JobListing) {
    const badges = [formatLocationRequirement(jobListing.locationRequirement), formatJobType(jobListing.type), formatExperienceLevel(jobListing.experienceLevel),]
