...
import { getUserNotificationSettingsIdTag } from "@/features/user/db/cache/userNotifSettings";
...
async function getNotificationSettings(userId: string) {
    ...
    return db.query.userNotifSettingsTable.findFirst({
        where: eq(userNotifSettingsTable.userId, userId),
        columns: { aiPrompt: true, newJobEmailNotifications: true },
    })
}