...
import { JobListingAiSearchForm } from "@/features/jobLists/components/JobListingAiSearchForm"
...
function NoPermission() {
    return (
        <CardContent className="text-center">
            ...
            <p className="mb-4 text-muted-foreground">You need to create an account before using AI search</p>
            <SignUpButton />
        </CardContent>
    )
}