...
import { updateUserNotificationSettings } from "../actions/userNotifs"

export function NotificationsForm({ notificationSettings }: { notificationSettings?: Pick<typeof userNotifSettingsTable.$inferSelect, "newJobEmailNotifications" | "aiPrompt"> }) {
                            ...
                            <FormItem>
                                <div className="flex items-center justify-between">
                                    <div className="space-y-0.5">
                                        ...
                                        <FormDescription>Receive emails about new job listings that match your interests</FormDescription>
                                    </div>
                                    <FormControl>
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>Leave blank to receive notifications of all new joblistings.</FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
                        />
