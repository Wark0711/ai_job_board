...
export function SidebarOrgButtonClient({ user, org }: { user: User, org: Organization }) {
...
function OrgInfo({ org, user }: { user: User, org: Organization }) {

    const nameInitials = org.name.split(" ").slice(0, 2).map(str => str[0]).join("")
